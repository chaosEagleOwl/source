...
5)useAngle - Demonstrates how the input context reactors PromptAngleOption and 
             PromptAngleResult works.
...
7)usepoint - Demonstrates how the input context reactors PromptPointOption and 
             PromptPointResult works.
...
10)GetNestentity - Try to draw a few nested entities like blocks and xrefs in the drawing 
   for the user to select. If the user selects a nested entity then the name of the nested 
   entity is displayed. Finally after the user is done selecting the entities, a non interactive 

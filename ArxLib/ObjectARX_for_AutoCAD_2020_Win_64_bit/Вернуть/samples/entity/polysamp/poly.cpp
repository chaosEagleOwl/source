...
AsdkPoly::AsdkPoly() :
    ...
    mPersSubentIdSolver(kDistributeIndicesProportionallyPersSubentIdSolver)
{}
...
AsdkPoly::PersSubentIdSolver AsdkPoly::getPersSubentIdSolver() const
{
    return mPersSubentIdSolver;
}

void AsdkPoly::setPersSubentIdSolver(AsdkPoly::PersSubentIdSolver persSubentIdSolver)
{
    assertWriteEnabled();
    mPersSubentIdSolver = persSubentIdSolver;
}
...
AsdkPoly::setNumSides(int numSides)    
{
    ...
    if (numSides < 3 || numSides > kMaxNumSides)
        return Acad::eInvalidInput;
...
AsdkPoly::dwgInFields(AcDbDwgFiler* filer)
{
    ...
    case 3:
    {
        ...
        if (version >= 3) {
            Adesk::Int32 persSubentIdSolverIndex = 0;
            filer->readInt32(&persSubentIdSolverIndex);
            mPersSubentIdSolver = (PersSubentIdSolver)persSubentIdSolverIndex;
        }
        break;
    }
    default:
...
AsdkPoly::dwgOutFields(AcDbDwgFiler* filer) const
{
    ...
    filer->writeInt32((Adesk::Int32)mPersSubentIdSolver);
    return filer->filerStatus();
}
        ...
        else
        {
            ...
            if (version >= 3) {
                ...
                if (rb.restype != AcDb::kDxfInt32+1)
                    throw AcDb::kDxfInt32+1;
                mPersSubentIdSolver = (PersSubentIdSolver)rb.resval.rlong;
            }
        } 
        else assert(false);
    }
...
AsdkPoly::dxfOutFields(AcDbDxfFiler* filer) const
{
    ...
    filer->writeInt32(AcDb::kDxfInt32 + 1, (int)mPersSubentIdSolver);
    return filer->filerStatus();
}

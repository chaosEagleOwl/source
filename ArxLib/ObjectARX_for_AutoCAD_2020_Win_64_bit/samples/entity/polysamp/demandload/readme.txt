...
Execute these tasks in order first:
  ...
  1. Using a text editor, update polysamp.reg.
     ...
     Install ID now uses the country code. Change "ACAD-2001:409" in the registry
     ...
     [HKEY_LOCAL_MACHINE\SOFTWARE\Autodesk\AutoCAD\R23.0\ACAD-2001:409\Applications\AsdkPolyCAD]
...
I. Command Invocation
     ...
     [HKEY_CURRENT_USER\SOFTWARE\Autodesk\AutoCAD\R23.0\ACAD-2001:409\Applications\AsdkPolyCAD\Commands]
     "ASDK_POLY"="POLY"
  ...
  3. Invoking the command POLY defined in polyui.arx will Demand
     ...
     [HKEY_CURRENT_USER\SOFTWARE\Autodesk\AutoCAD\R23.0\ACAD-2001:409\Applications\AsdkPolyCAD\Groups]
...
II. Proxy Detection
     ...
     [HKEY_CURRENT_USER\SOFTWARE\Autodesk\ObjectDBX\R23.0\Applications\AsdkPolyOBJ2.0]

...
public:
    ...
    static const int kMaxNumSides = 9999; 

    enum PersSubentIdSolver
    {
        kFixedIndicesPersSubentIdSolver = 1,
        kDistributeIndicesProportionallyPersSubentIdSolver = 2,
    };

    // Specifies which algorithm is used to persistenty identify subentities
    // (edges, vertices) of the entity. This is for demonstration purpose only
    // 
    PersSubentIdSolver getPersSubentIdSolver() const;
    void setPersSubentIdSolver(PersSubentIdSolver);
...
private:
    ...
    // (edges, vertices) of the entity. This is for demonstration purpose only
    // 
    PersSubentIdSolver mPersSubentIdSolver;
